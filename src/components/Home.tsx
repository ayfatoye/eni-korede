    ...
    <div className="w-screen">
      ...
      <div>
        ...
        <div className="text-[#717769] w-3/4 mx-auto text-lg md:text-2xl font-light md:font-medium pb-6 pt-3 md:pb-12 md:pt-4">
          ...
          <p className="py-2">For any questions or concerns, please feel free to reach out to the Event Coordinator (832 679-4576), Abisola Oladigbo (773 964-9462), or Boluwatife Fatoye (832 845 0815)</p>
        </div>
